...
export class API {
  ...
  */
  Status(onCashExpire?: getPromise<API_Status>):Promise<API_Status>{
    return this.TBAGet(`/status`,onCashExpire)
  }
  /**
  ...
  */
  ...
  Teams(par1: number, par2?: number | getPromise<Team[]>, par3?: getPromise<Team[]>){
    if(typeof par2 == 'number'){
      return this.TBAGet(`/teams/${par1}/${par2}`, par3)
    }else {
      return this.TBAGet(`/teams/${par1}`, par2)
    }
  }
  /**
  ...
  */
  ...
  TeamsSimple(par1: number, par2?: number | getPromise<Team_Simple[]>, par3?: getPromise<Team_Simple[]>){
    if(typeof par2 == 'number'){
      return this.TBAGet(`/teams/${par1}/${par2}/simple`, par3)
    }else {
      return this.TBAGet(`/teams/${par1}/simple`, par2)
    }
  }
  /**
  ...
  */
  ...
  TeamsKeys(par1: number, par2?: number | getPromise<string[]>, par3?: getPromise<string[]>){
    if(typeof par2 == 'number'){
      return this.TBAGet(`/teams/${par1}/${par2}/keys`, par3)
    }else {
      return this.TBAGet(`/teams/${par1}/keys`, par2)
    }
  }
  /**
  ...
  */
  Team(team_key: string, onCashExpire?: getPromise<Team>):Promise<Team>{
    return this.TBAGet(`/team/${team_key}`,onCashExpire)
  }
  /**
  ...
  */
  TeamSimple(team_key: string, onCashExpire?: getPromise<Team_Simple>):Promise<Team_Simple>{
    return this.TBAGet(`/team/${team_key}/simple`,onCashExpire)
  }
  /**
  ...
  */
  TeamYears_participated(team_key: string, onCashExpire?: getPromise<number[]>):Promise<number[]>{
    return this.TBAGet(`/team/${team_key}/years_participated`,onCashExpire)
  }
  /**
  ...
  */
  TeamDistricts(team_key: string, onCashExpire?: getPromise<District_List[]>):Promise<District_List[]>{
    return this.TBAGet(`/team/${team_key}/districts`,onCashExpire)
  }
  /**
  ...
  */
  TeamRobots(team_key: string, onCashExpire?: getPromise<{[key:string]:Team_Robot}>):Promise<{[key:string]:Team_Robot}>{
    return this.TBAGet(`/team/${team_key}/robots`,onCashExpire)
  }
  /**
  ...
  */
  ...
  TeamEvents(par1: string, par2?: number | getPromise<Event[]>, par3?: getPromise<Event[]>){
    if(typeof par2 == 'number'){
      return this.TBAGet(`/team/${par1}/events/${par2}`, par3)
    }else {
      return this.TBAGet(`/team/${par1}/events`, par2)
    }
  }
  /**
  ...
  */
  ...
  TeamEventsSimple(par1: string, par2?: number | getPromise<Event_Simple[]>, par3?: getPromise<Event_Simple[]>){
    if(typeof par2 == 'number'){
      return this.TBAGet(`/team/${par1}/events/${par2}/simple`, par3)
    }else {
      return this.TBAGet(`/team/${par1}/events/simple`, par2)
    }
  }
  /**
  ...
  */
  ...
  TeamEventsKeys(par1: string, par2?: number | getPromise<string[]>, par3?: getPromise<string[]>){
    if(typeof par2 == 'number'){
      return this.TBAGet(`/team/${par1}/events/${par2}/keys`, par3)
    }else {
      return this.TBAGet(`/team/${par1}/events/keys`, par2)
    }
  }
  /**
  ...
  */
  TeamEventsStatuses(team_key: string, year: number, onCashExpire?: getPromise<{[event_key:string]:Team_Event_Status}>):Promise<{[event_key:string]:Team_Event_Status}>{
    return this.TBAGet(`/team/${team_key}/events/${year}/statuses`,onCashExpire)
  }
  /**
  ...
  */
  TeamEventMatches(team_key: string, event_key: string, onCashExpire?: getPromise<Match[]>):Promise<Match[]>{
    return this.TBAGet(`/team/${team_key}/event/${event_key}/matches`,onCashExpire)
  }
  /**
  ...
  */
  TeamEventMatchesSimple(team_key: string, event_key: string, onCashExpire?: getPromise<Match[]>):Promise<Match[]>{
    return this.TBAGet(`/team/${team_key}/event/${event_key}/matches/simple`,onCashExpire)
  }
  /**
  ...
  */
  TeamEventMatchesKeys(team_key: string, event_key: string, onCashExpire?: getPromise<string[]>):Promise<string[]>{
    return this.TBAGet(`/team/${team_key}/event/${event_key}/matches/keys`,onCashExpire)
  }
  /**
  ...
  */
  TeamEventAwards(team_key: string, event_key: string, onCashExpire?: getPromise<Award[]>):Promise<Award[]>{
    return this.TBAGet(`/team/${team_key}/event/${event_key}/awards`,onCashExpire)
  }
  /**
  ...
  */
  TeamEventStatus(team_key: string, event_key: string, onCashExpire?: getPromise<Team_Event_Status>):Promise<Team_Event_Status>{
    return this.TBAGet(`/team/${team_key}/event/${event_key}/status`,onCashExpire)
  }
  /**
  ...
  */
  ...
  TeamAwards(par1: string, par2?: number | getPromise<Award[]>, par3?: getPromise<Award[]>){
    if(typeof par2 == 'number'){
      return this.TBAGet(`/team/${par1}/awards/${par2}`, par3)
    }else {
      return this.TBAGet(`/team/${par1}/awards`, par2)
    }
  }
  /**
  ...
  */
  TeamMatches(team_key: string, year: number, onCashExpire?: getPromise<Match[]>):Promise<Match[]>{
    return this.TBAGet(`/team/${team_key}/matches/${year}`,onCashExpire)
  }
  /**
  ...
  */
  TeamMatchesSimple(team_key: string, year: number, onCashExpire?: getPromise<Match_Simple[]>):Promise<Match_Simple[]>{
    return this.TBAGet(`/team/${team_key}/matches/${year}/simple`,onCashExpire)
  }
  /**
  ...
  */
  TeamMatchesKeys(team_key: string, year: number, onCashExpire?: getPromise<string[]>):Promise<string[]>{
    return this.TBAGet(`/team/${team_key}/matches/${year}/keys`,onCashExpire)
  }
  /**
  ...
  */
  ...
  TeamMedia(par1: string, par2: number | string, par3?: number | getPromise<Media[]>, par4?: getPromise<Media[]>){
    if(typeof par2 == 'number'){
      if(typeof par3 == 'number'){
        throw new Error('Parameter 3 is of a wrong type')
      }else {
        return this.TBAGet(`/team/${par1}/media/${par2}`, par3)
      }
    }else {
      if(typeof par3 == 'number'){
        return this.TBAGet(`/team/${par1}/media/tag/${par2}/${par3}`, par4)
      }else {
        return this.TBAGet(`/team/${par1}/media/tag/${par2}`, par3)
      }
    }
  }
  /**
  ...
  */
  TeamSocial_media(team_key: string, onCashExpire?: getPromise<Media[]>):Promise<Media[]>{
    return this.TBAGet(`/team/${team_key}/social_media`,onCashExpire)
  }
  /**
  ...
  */
  Events(year: number, onCashExpire?: getPromise<Event[]>):Promise<Event[]>{
    return this.TBAGet(`/events/${year}`,onCashExpire)
  }
  /**
  ...
  */
  EventsSimple(year: number, onCashExpire?: getPromise<Event_Simple[]>):Promise<Event_Simple[]>{
    return this.TBAGet(`/events/${year}/simple`,onCashExpire)
  }
  /**
  ...
  */
  EventsKeys(year: number, onCashExpire?: getPromise<string[]>):Promise<string[]>{
    return this.TBAGet(`/events/${year}/keys`,onCashExpire)
  }
  /**
  * Gets an Event.
  *
  ...
  */
  Event(event_key: string, onCashExpire?: getPromise<Event>):Promise<Event>{
    return this.TBAGet(`/event/${event_key}`,onCashExpire)
  }
  /**
  ...
  */
  EventSimple(event_key: string, onCashExpire?: getPromise<Event_Simple>):Promise<Event_Simple>{
    return this.TBAGet(`/event/${event_key}/simple`,onCashExpire)
  }
  /**
  ...
  */
  EventAlliances(event_key: string, onCashExpire?: getPromise<Elimination_Alliance[]>):Promise<Elimination_Alliance[]>{
    return this.TBAGet(`/event/${event_key}/alliances`,onCashExpire)
  }
  /**
  ...
  */
  EventInsights(event_key: string, onCashExpire?: getPromise<{[key:string]:any}>):Promise<{[key:string]:any}>{
    return this.TBAGet(`/event/${event_key}/insights`,onCashExpire)
  }
  /**
  ...
  */
  EventOprs(event_key: string, onCashExpire?: getPromise<Event_OPRs>):Promise<Event_OPRs>{
    return this.TBAGet(`/event/${event_key}/oprs`,onCashExpire)
  }
  /**
  ...
  */
  EventPredictions(event_key: string, onCashExpire?: getPromise<Event_Predictions>):Promise<Event_Predictions>{
    return this.TBAGet(`/event/${event_key}/predictions`,onCashExpire)
  }
  /**
  ...
  */
  EventRankings(event_key: string, onCashExpire?: getPromise<Event_Ranking>):Promise<Event_Ranking>{
    return this.TBAGet(`/event/${event_key}/rankings`,onCashExpire)
  }
  /**
  * Gets a list of team rankings for the Event.
  *
  ...
  */
  EventDistrict_points(event_key: string, onCashExpire?: getPromise<Event_District_Points>):Promise<Event_District_Points>{
    return this.TBAGet(`/event/${event_key}/district_points`,onCashExpire)
  }
  /**
  ...
  */
  EventTeams(event_key: string, onCashExpire?: getPromise<Team[]>):Promise<Team[]>{
    return this.TBAGet(`/event/${event_key}/teams`,onCashExpire)
  }
  /**
  ...
  */
  EventTeamsSimple(event_key: string, onCashExpire?: getPromise<Team_Simple[]>):Promise<Team_Simple[]>{
    return this.TBAGet(`/event/${event_key}/teams/simple`,onCashExpire)
  }
  /**
  ...
  */
  EventTeamsKeys(event_key: string, onCashExpire?: getPromise<string[]>):Promise<string[]>{
    return this.TBAGet(`/event/${event_key}/teams/keys`,onCashExpire)
  }
  /**
  ...
  */
  EventTeamsStatuses(event_key: string, onCashExpire?: getPromise<{[event_key:string]:Team_Event_Status}>):Promise<{[event_key:string]:Team_Event_Status}>{
    return this.TBAGet(`/event/${event_key}/teams/statuses`,onCashExpire)
  }
  /**
  ...
  */
  EventMatches(event_key: string, onCashExpire?: getPromise<Match[]>):Promise<Match[]>{
    return this.TBAGet(`/event/${event_key}/matches`,onCashExpire)
  }
  /**
  ...
  */
  EventMatchesSimple(event_key: string, onCashExpire?: getPromise<Match_Simple[]>):Promise<Match_Simple[]>{
    return this.TBAGet(`/event/${event_key}/matches/simple`,onCashExpire)
  }
  /**
  ...
  */
  EventMatchesKeys(event_key: string, onCashExpire?: getPromise<string[]>):Promise<string[]>{
    return this.TBAGet(`/event/${event_key}/matches/keys`,onCashExpire)
  }
  /**
  ...
  */
  EventAwards(event_key: string, onCashExpire?: getPromise<Award[]>):Promise<Award[]>{
    return this.TBAGet(`/event/${event_key}/awards`,onCashExpire)
  }
  /**
  ...
  */
  Match(match_key: string, onCashExpire?: getPromise<Match>):Promise<Match>{
    return this.TBAGet(`/match/${match_key}`,onCashExpire)
  }
  /**
  ...
  */
  Districts(year: number, onCashExpire?: getPromise<District_List[]>):Promise<District_List[]>{
    return this.TBAGet(`/districts/${year}`,onCashExpire)
  }
  /**
  ...
  */
  DistrictEvents(district_key: string, onCashExpire?: getPromise<Event[]>):Promise<Event[]>{
    return this.TBAGet(`/district/${district_key}/events`,onCashExpire)
  }
  /**
  ...
  */
  DistrictEventsSimple(district_key: string, onCashExpire?: getPromise<Event_Simple[]>):Promise<Event_Simple[]>{
    return this.TBAGet(`/district/${district_key}/events/simple`,onCashExpire)
  }
  /**
  ...
  */
  DistrictEventsKeys(district_key: string, onCashExpire?: getPromise<string[]>):Promise<string[]>{
    return this.TBAGet(`/district/${district_key}/events/keys`,onCashExpire)
  }
  /**
  ...
  */
  DistrictTeams(district_key: string, onCashExpire?: getPromise<Team[]>):Promise<Team[]>{
    return this.TBAGet(`/district/${district_key}/teams`,onCashExpire)
  }
  /**
  ...
  */
  DistrictTeamsSimple(district_key: string, onCashExpire?: getPromise<Team_Simple[]>):Promise<Team_Simple[]>{
    return this.TBAGet(`/district/${district_key}/teams/simple`,onCashExpire)
  }
  /**
  * Gets a list of `Team` objects that competed in events in the given district.
  *
  ...
  */
  DistrictTeamsKeys(district_key: string, onCashExpire?: getPromise<string[]>):Promise<string[]>{
    return this.TBAGet(`/district/${district_key}/teams/keys`,onCashExpire)
  }
  /**
