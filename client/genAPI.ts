...
export class API {
  ...
  */
  ...
  Status(par1?: getValue<API_Status> | getPromise<API_Status>, par2?: boolean): any {
    return this.TBAGet(`/status`, par1, par2)
  }
  ...
  */
  ...
  Teams(par1: number, par2?: number | getValue<Team[]> | getPromise<Team[]>, par3?: boolean | getValue<Team[]> | getPromise<Team[]>, par4?: boolean): any {
    if(typeof par2 == 'number'){
      if(typeof par3 == 'function'){
        return this.TBAGet(`/teams/${par1}/${par2}`, par3, par4)
      }
    }else {
      if(typeof par3 == 'boolean'){
        return this.TBAGet(`/teams/${par1}`, par2, par3)
      }else {
        throw new Error('Parameter 3 is of a wrong type')
      }
    }
  }
  ...
  */
  ...
  TeamsSimple(par1: number, par2?: number | getValue<Team_Simple[]> | getPromise<Team_Simple[]>, par3?: boolean | getValue<Team_Simple[]> | getPromise<Team_Simple[]>, par4?: boolean): any {
    if(typeof par2 == 'number'){
      if(typeof par3 == 'function'){
        return this.TBAGet(`/teams/${par1}/${par2}/simple`, par3, par4)
      }
    }else {
      if(typeof par3 == 'boolean'){
        return this.TBAGet(`/teams/${par1}/simple`, par2, par3)
      }else {
        throw new Error('Parameter 3 is of a wrong type')
      }
    }
  ...
  */
  ...
  TeamsKeys(par1: number, par2?: number | getValue<string[]> | getPromise<string[]>, par3?: boolean | getValue<string[]> | getPromise<string[]>, par4?: boolean): any {
    if(typeof par2 == 'number'){
      if(typeof par3 == 'function'){
        return this.TBAGet(`/teams/${par1}/${par2}/keys`, par3, par4)
      }
    }else {
      if(typeof par3 == 'boolean'){
        return this.TBAGet(`/teams/${par1}/keys`, par2, par3)
      }else {
        throw new Error('Parameter 3 is of a wrong type')
      }
    }
  ...
  */
  ...
  Team(par1: string, par2?: getValue<Team> | getPromise<Team>, par3?: boolean): any {
    return this.TBAGet(`/team/${par1}`, par2, par3)
  }
  ...
  */
  ...
  TeamSimple(par1: string, par2?: getValue<Team_Simple> | getPromise<Team_Simple>, par3?: boolean): any {
    return this.TBAGet(`/team/${par1}/simple`, par2, par3)
  }
  ...
  */
  ...
  TeamYears_participated(par1: string, par2?: getValue<number[]> | getPromise<number[]>, par3?: boolean): any {
    return this.TBAGet(`/team/${par1}/years_participated`, par2, par3)
  }
  ...
  */
  ...
  TeamDistricts(par1: string, par2?: getValue<District_List[]> | getPromise<District_List[]>, par3?: boolean): any {
    return this.TBAGet(`/team/${par1}/districts`, par2, par3)
  }
  ...
  * @param subscribe Get New Value upon change
  */
  TeamRobots(team_key: string, callback: getValue<{[key:string]:Team_Robot}>, subscribe?: boolean):number
  TeamRobots(par1: string, par2?: getValue<{[key:string]:Team_Robot}> | getPromise<{[key:string]:Team_Robot}>, par3?: boolean): any {
    return this.TBAGet(`/team/${par1}/robots`, par2, par3)
  }
  ...
  */
  ...
  TeamEvents(par1: string, par2?: number | getValue<Event[]> | getPromise<Event[]>, par3?: boolean | getValue<Event[]> | getPromise<Event[]>, par4?: boolean): any {
    if(typeof par2 == 'number'){
      if(typeof par3 == 'function'){
        return this.TBAGet(`/team/${par1}/events/${par2}`, par3, par4)
      }
    }else {
      if(typeof par3 == 'boolean'){
        return this.TBAGet(`/team/${par1}/events`, par2, par3)
      }else {
        throw new Error('Parameter 3 is of a wrong type')
      }
    }
  ...
  */
  ...
  TeamEventsSimple(par1: string, par2?: number | getValue<Event_Simple[]> | getPromise<Event_Simple[]>, par3?: boolean | getValue<Event_Simple[]> | getPromise<Event_Simple[]>, par4?: boolean): any {
    if(typeof par2 == 'number'){
      if(typeof par3 == 'function'){
        return this.TBAGet(`/team/${par1}/events/${par2}/simple`, par3, par4)
      }
    }else {
      if(typeof par3 == 'boolean'){
        return this.TBAGet(`/team/${par1}/events/simple`, par2, par3)
      }else {
        throw new Error('Parameter 3 is of a wrong type')
      }
    }
  ...
  */
  ...
  TeamEventsKeys(par1: string, par2?: number | getValue<string[]> | getPromise<string[]>, par3?: boolean | getValue<string[]> | getPromise<string[]>, par4?: boolean): any {
    if(typeof par2 == 'number'){
      if(typeof par3 == 'function'){
        return this.TBAGet(`/team/${par1}/events/${par2}/keys`, par3, par4)
      }
    }else {
      if(typeof par3 == 'boolean'){
        return this.TBAGet(`/team/${par1}/events/keys`, par2, par3)
      }else {
        throw new Error('Parameter 3 is of a wrong type')
      }
    }
  ...
  * @param subscribe Get New Value upon change
  */
  TeamEventsStatuses(team_key: string, year: number, callback: getValue<{[event_key:string]:Team_Event_Status}>, subscribe?: boolean):number
  TeamEventsStatuses(par1: string, par2: number, par3?: getValue<{[event_key:string]:Team_Event_Status}> | getPromise<{[event_key:string]:Team_Event_Status}>, par4?: boolean): any {
    return this.TBAGet(`/team/${par1}/events/${par2}/statuses`, par3, par4)
  }
  ...
  */
  ...
  TeamEventMatches(par1: string, par2: string, par3?: getValue<Match[]> | getPromise<Match[]>, par4?: boolean): any {
    return this.TBAGet(`/team/${par1}/event/${par2}/matches`, par3, par4)
  }
  ...
  */
  ...
  TeamEventMatchesSimple(par1: string, par2: string, par3?: getValue<Match[]> | getPromise<Match[]>, par4?: boolean): any {
    return this.TBAGet(`/team/${par1}/event/${par2}/matches/simple`, par3, par4)
  }
  ...
  */
  ...
  TeamEventMatchesKeys(par1: string, par2: string, par3?: getValue<string[]> | getPromise<string[]>, par4?: boolean): any {
    return this.TBAGet(`/team/${par1}/event/${par2}/matches/keys`, par3, par4)
  }
  ...
  */
  ...
  TeamEventAwards(par1: string, par2: string, par3?: getValue<Award[]> | getPromise<Award[]>, par4?: boolean): any {
    return this.TBAGet(`/team/${par1}/event/${par2}/awards`, par3, par4)
  }
  ...
  */
  ...
  TeamEventStatus(par1: string, par2: string, par3?: getValue<Team_Event_Status> | getPromise<Team_Event_Status>, par4?: boolean): any {
    return this.TBAGet(`/team/${par1}/event/${par2}/status`, par3, par4)
  }
  ...
  */
  ...
  TeamAwards(par1: string, par2?: number | getValue<Award[]> | getPromise<Award[]>, par3?: boolean | getValue<Award[]> | getPromise<Award[]>, par4?: boolean): any {
    if(typeof par2 == 'number'){
      if(typeof par3 == 'function'){
        return this.TBAGet(`/team/${par1}/awards/${par2}`, par3, par4)
      }
    }else {
      if(typeof par3 == 'boolean'){
        return this.TBAGet(`/team/${par1}/awards`, par2, par3)
      }else {
        throw new Error('Parameter 3 is of a wrong type')
      }
    }
  ...
  */
  ...
  TeamMatches(par1: string, par2: number, par3?: getValue<Match[]> | getPromise<Match[]>, par4?: boolean): any {
    return this.TBAGet(`/team/${par1}/matches/${par2}`, par3, par4)
  }
  ...
  */
  ...
  TeamMatchesSimple(par1: string, par2: number, par3?: getValue<Match_Simple[]> | getPromise<Match_Simple[]>, par4?: boolean): any {
    return this.TBAGet(`/team/${par1}/matches/${par2}/simple`, par3, par4)
  }
  ...
  */
  ...
  TeamMatchesKeys(par1: string, par2: number, par3?: getValue<string[]> | getPromise<string[]>, par4?: boolean): any {
    return this.TBAGet(`/team/${par1}/matches/${par2}/keys`, par3, par4)
  }
  ...
  */
  ...
  TeamMedia(par1: string, par2: number | string, par3?: number | getValue<Media[]> | getPromise<Media[]>, par4?: boolean | getValue<Media[]> | getPromise<Media[]>, par5?: boolean): any {
    if(typeof par2 == 'number'){
      if(typeof par3 == 'number'){
        if(typeof par4 == 'function'){
          throw new Error('Parameter 4 is of a wrong type')
        }
      }else {
        if(typeof par4 == 'boolean'){
          return this.TBAGet(`/team/${par1}/media/${par2}`, par3, par4)
        }else {
          throw new Error('Parameter 4 is of a wrong type')
        }
      }
      ...
      if(typeof par3 == 'number'){
        if(typeof par4 == 'function'){
          return this.TBAGet(`/team/${par1}/media/tag/${par2}/${par3}`, par4, par5)
        }
      }else {
        if(typeof par4 == 'function'){
          throw new Error('Parameter 4 is of a wrong type')
  ...
  */
  ...
  TeamSocial_media(par1: string, par2?: getValue<Media[]> | getPromise<Media[]>, par3?: boolean): any {
    return this.TBAGet(`/team/${par1}/social_media`, par2, par3)
  }
  ...
  */
  ...
  Events(par1: number, par2?: getValue<Event[]> | getPromise<Event[]>, par3?: boolean): any {
    return this.TBAGet(`/events/${par1}`, par2, par3)
  }
  ...
  */
  ...
  EventsSimple(par1: number, par2?: getValue<Event_Simple[]> | getPromise<Event_Simple[]>, par3?: boolean): any {
    return this.TBAGet(`/events/${par1}/simple`, par2, par3)
  }
  ...
  */
  ...
  EventsKeys(par1: number, par2?: getValue<string[]> | getPromise<string[]>, par3?: boolean): any {
    return this.TBAGet(`/events/${par1}/keys`, par2, par3)
  }
  ...
  */
  ...
  Event(par1: string, par2?: getValue<Event> | getPromise<Event>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}`, par2, par3)
  }
  ...
  */
  ...
  EventSimple(par1: string, par2?: getValue<Event_Simple> | getPromise<Event_Simple>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/simple`, par2, par3)
  }
  ...
  */
  ...
  EventAlliances(par1: string, par2?: getValue<Elimination_Alliance[]> | getPromise<Elimination_Alliance[]>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/alliances`, par2, par3)
  }
  ...
  * @param subscribe Get New Value upon change
  */
  EventInsights(event_key: string, callback: getValue<{[key:string]:any}>, subscribe?: boolean):number
  EventInsights(par1: string, par2?: getValue<{[key:string]:any}> | getPromise<{[key:string]:any}>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/insights`, par2, par3)
  }
  ...
  */
  ...
  EventOprs(par1: string, par2?: getValue<Event_OPRs> | getPromise<Event_OPRs>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/oprs`, par2, par3)
  }
  ...
  */
  ...
  EventPredictions(par1: string, par2?: getValue<Event_Predictions> | getPromise<Event_Predictions>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/predictions`, par2, par3)
  }
  ...
  */
  ...
  EventRankings(par1: string, par2?: getValue<Event_Ranking> | getPromise<Event_Ranking>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/rankings`, par2, par3)
  }
  ...
  */
  ...
  EventDistrict_points(par1: string, par2?: getValue<Event_District_Points> | getPromise<Event_District_Points>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/district_points`, par2, par3)
  }
  ...
  */
  ...
  EventTeams(par1: string, par2?: getValue<Team[]> | getPromise<Team[]>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/teams`, par2, par3)
  }
  ...
  */
  ...
  EventTeamsSimple(par1: string, par2?: getValue<Team_Simple[]> | getPromise<Team_Simple[]>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/teams/simple`, par2, par3)
  }
  ...
  */
  ...
  EventTeamsKeys(par1: string, par2?: getValue<string[]> | getPromise<string[]>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/teams/keys`, par2, par3)
  }
  ...
  * @param subscribe Get New Value upon change
  */
  EventTeamsStatuses(event_key: string, callback: getValue<{[event_key:string]:Team_Event_Status}>, subscribe?: boolean):number
  EventTeamsStatuses(par1: string, par2?: getValue<{[event_key:string]:Team_Event_Status}> | getPromise<{[event_key:string]:Team_Event_Status}>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/teams/statuses`, par2, par3)
  }
  ...
  */
  ...
  EventMatches(par1: string, par2?: getValue<Match[]> | getPromise<Match[]>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/matches`, par2, par3)
  }
  ...
  */
  ...
  EventMatchesSimple(par1: string, par2?: getValue<Match_Simple[]> | getPromise<Match_Simple[]>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/matches/simple`, par2, par3)
  }
  ...
  */
  ...
  EventMatchesKeys(par1: string, par2?: getValue<string[]> | getPromise<string[]>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/matches/keys`, par2, par3)
  }
  ...
  */
  ...
  EventMatchesTimeseries(par1: string, par2?: getValue<string[]> | getPromise<string[]>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/matches/timeseries`, par2, par3)
  }
  ...
  */
  ...
  EventAwards(par1: string, par2?: getValue<Award[]> | getPromise<Award[]>, par3?: boolean): any {
    return this.TBAGet(`/event/${par1}/awards`, par2, par3)
  }
  ...
  */
  ...
  Match(par1: string, par2?: getValue<Match> | getPromise<Match>, par3?: boolean): any {
    return this.TBAGet(`/match/${par1}`, par2, par3)
  }
  ...
  */
  ...
  MatchSimple(par1: string, par2?: getValue<Match_Simple> | getPromise<Match_Simple>, par3?: boolean): any {
    return this.TBAGet(`/match/${par1}/simple`, par2, par3)
  }
  ...
  * @param subscribe Get New Value upon change
  */
  MatchTimeseries(match_key: string, callback: getValue<{[key:string]:any}[]>, subscribe?: boolean):number
  MatchTimeseries(par1: string, par2?: getValue<{[key:string]:any}[]> | getPromise<{[key:string]:any}[]>, par3?: boolean): any {
    return this.TBAGet(`/match/${par1}/timeseries`, par2, par3)
  }
  ...
  */
  ...
  Districts(par1: number, par2?: getValue<District_List[]> | getPromise<District_List[]>, par3?: boolean): any {
    return this.TBAGet(`/districts/${par1}`, par2, par3)
  }
  ...
  */
  ...
  DistrictEvents(par1: string, par2?: getValue<Event[]> | getPromise<Event[]>, par3?: boolean): any {
    return this.TBAGet(`/district/${par1}/events`, par2, par3)
  }
  ...
  */
  ...
  DistrictEventsSimple(par1: string, par2?: getValue<Event_Simple[]> | getPromise<Event_Simple[]>, par3?: boolean): any {
    return this.TBAGet(`/district/${par1}/events/simple`, par2, par3)
  }
  ...
  */
  ...
  DistrictEventsKeys(par1: string, par2?: getValue<string[]> | getPromise<string[]>, par3?: boolean): any {
    return this.TBAGet(`/district/${par1}/events/keys`, par2, par3)
  }
  ...
  */
  ...
  DistrictTeams(par1: string, par2?: getValue<Team[]> | getPromise<Team[]>, par3?: boolean): any {
    return this.TBAGet(`/district/${par1}/teams`, par2, par3)
  }
  ...
  */
  ...
  DistrictTeamsSimple(par1: string, par2?: getValue<Team_Simple[]> | getPromise<Team_Simple[]>, par3?: boolean): any {
    return this.TBAGet(`/district/${par1}/teams/simple`, par2, par3)
  }
  ...
  */
  ...
  DistrictTeamsKeys(par1: string, par2?: getValue<string[]> | getPromise<string[]>, par3?: boolean): any {
    return this.TBAGet(`/district/${par1}/teams/keys`, par2, par3)
  }
  ...
  */
  ...
  DistrictRankings(par1: string, par2?: getValue<District_Ranking[]> | getPromise<District_Ranking[]>, par3?: boolean): any {
    return this.TBAGet(`/district/${par1}/rankings`, par2, par3)
  }
...
export interface Team{
  ...
  home_championship?:{[key:string]:any}
}
